...
// the app delegate creates a custom NSDocumentController subclass
// when -applicationWillFinishLaunching: is called. see
// SPDocumentController.h for more details on how the subclass is
// used.
